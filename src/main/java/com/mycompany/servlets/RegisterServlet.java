    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (username.equals("")) {
                ...
                httpsession.setAttribute("errormessage", "Please Enter User Name!");
                ...
                HttpSession httpsession = request.getSession();
                httpsession.setAttribute("errormessage", "Please Enter Phone Number!");
                response.sendRedirect("Register.jsp");
            } else if (user_address.equals("")) {
                HttpSession httpsession = request.getSession();
                httpsession.setAttribute("errormessage", "Please Enter Address!");
                response.sendRedirect("Register.jsp");
            } else {
